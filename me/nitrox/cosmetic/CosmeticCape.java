...
public class CosmeticCape implements LayerRenderer<AbstractClientPlayer> {
	...
	private String BetaCape = "1BlueNitrox";
	...
	public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_,
		...
		if ((entitylivingbaseIn.getName() == Minecraft.getMinecraft().thePlayer.getName()) && !entitylivingbaseIn.isInvisible()) {

		
			
			ResourceLocation EarsColor = new ResourceLocation("NitroxClient/Cape.png");

			GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
			this.playerRenderer.bindTexture(EarsColor);
